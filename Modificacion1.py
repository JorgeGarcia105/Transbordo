...
# Datos de oferta y demanda con el cambio realizado
oferta = {
    "I1": 300, "I2": 400, "I3": 80, "I4": 200, "I5": 380, "I6": 230, "I7": 450  # Cambio de I3 a 80
}
...
# Costos modificados para algunos arcos para ver un cambio en la optimización
costos = {
    ("I1", "J1"): 230, ("I1", "J2"): 250, ("I1", "K1"): 290, ("I2", "J1"): 250,
    ("I2", "J4"): 280, ("I3", "J2"): 300, ("I3", "J3"): 330, ("I4", "J1"): 190,
    ("I4", "J2"): 225, ("I4", "J4"): 300, ("I5", "J3"): 310, ("I6", "J3"): 360,
    ("I6", "J4"): 310, ("I7", "J1"): 280, ("I7", "J2"): 320, ("I7", "K1"): 220,
    ("J1", "K1"): 340, ("J1", "K4"): 300, ("J1", "K5"): 310, ("J1", "K7"): 270,
    ("J1", "K8"): 320, ("J1", "K10"): 350, ("J2", "K4"): 330, ("J2", "K6"): 270,
    ("J2", "K7"): 290, ("J2", "K10"): 335, ("J3", "K1"): 370, ("J3", "K2"): 200,
    ("J3", "K3"): 300, ("J3", "K5"): 330, ("J3", "K9"): 260, ("J4", "K1"): 200,
    ("J4", "K5"): 320, ("J4", "K6"): 340
}
...
prob += x["I1", "J1"] + x["I1", "J2"] + x["I1", "K1"] <= 250, "Oferta_I1"  # Cambio de 300 a 250
prob += x["I2", "J1"] + x["I2", "J4"] <= 400, "Oferta_I2"
prob += x["I3", "J2"] + x["I3", "J3"] <= 120, "Oferta_I3"
prob += x["I4", "J1"] + x["I4", "J2"] + x["I4", "J4"] <= 200, "Oferta_I4"
prob += x["I5", "J3"] <= 380, "Oferta_I5"
prob += x["I6", "J3"] + x["I6", "J4"] <= 230, "Oferta_I6"
prob += x["I7", "J1"] + x["I7", "J2"] + x["I7", "K1"] <= 350, "Oferta_I7"  # Cambio de 400 a 350
