...
oferta = {
    "I1": 300, "I2": 400, "I3": 360, "I4": 200, "I5": 380, "I6": 230, "I7": 400
}
...
prob += x["I1", "K1"] + x["J1", "K1"] + x["J3", "K1"] + x["J4", "K1"] + x["I7", "K1"] == 120, "Demanda_K1"
prob += x["J3", "K2"] == 100, "Demanda_K2"
prob += x["J3", "K3"] == 80, "Demanda_K3"
prob += x["J1", "K4"] + x["J2", "K4"] == 100, "Demanda_K4"
prob += x["J1", "K5"] + x["J3", "K5"] + x["J4", "K5"] == 140, "Demanda_K5"
prob += x["J2", "K6"] + x["J4", "K6"] == 200, "Demanda_K6"
prob += x["J1", "K7"] + x["J2", "K7"] == 60, "Demanda_K7"
prob += x["J1", "K8"] == 90, "Demanda_K8"
prob += x["J3", "K9"] == 90, "Demanda_K9"
prob += x["J1", "K10"] + x["J2", "K10"] == 100, "Demanda_K10"
...
pos = {
    "I1": (0, 0), "I2": (0, -15), "I3": (0, -20), "I4": (0, -30),
    "I5": (0, -50), "I6": (0, -40), "I7": (0, -70),  # Oferta
    "J1": (4, 0), "J2": (4, -20), "J3": (4, -40), "J4": (4, -60),  # Transbordo
    "K1": (8, -90), "K2": (8, -60), "K3": (8, -80), "K4": (8, -10),
    "K5": (8, 0), "K6": (8, -50), "K7": (8, -30), "K8": (8, -20),
    "K9": (8, -70), "K10": (8, -40),  # Demanda
}
